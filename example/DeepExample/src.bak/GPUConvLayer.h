 ...
 * func :   普通卷积层，默认使用2x2池化，如果使用更加复杂的池化，请使用GPUPoolLayer
 * history:
 */
...
public:
     ...
     * @active_type     激活函数
     */
    GPUConvLayer(int kernel_size, int kernel_count, conv_active_t active_type=CONV_ACTIVE_RELU, const char* name = "ConvLayer");
    ~GPUConvLayer();
    /**
