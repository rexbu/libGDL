...
jint registerJNIMethod(JNIEnv *env, jclass jc, jlong so, jstring jclassname, jstring jfunc,
                       jstring jsignature);
#ifdef __cplusplus
}
#endif
...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {  
    ...
    */
    ...
    JNINativeMethod method[2] = {
    	...
    	{"registerJNIMethod", "(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)I", (void*)registerJNIMethod}
    	};
...
jint registerJNIMethod(JNIEnv *env, jclass jc, jlong so, jstring jclassname, jstring jfunc, jstring jsignature){
