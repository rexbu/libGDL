...
public class HttpUtil {
    ...
    private static InputStream urlInputStream(HttpURLConnection conn) throws IOException {
        return conn.getInputStream();
    }

    private static InputStream urlInputStream(String urlStr) throws IOException {
    ...
    private static Bitmap getBitMap(InputStream is) throws IOException {
    ...
    public static String get(String host, String query) throws IOException{
        ...
        String requestHeader = ("GET " + "http://") + host + query + " HTTP/1.0\r\n" +
                "Proxy-Connection: Keep-Alive\r\n" +
                "Host: " + host + "\r\n" +
                "Accept: Accept: textml,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8\r\n" +
                "User-Agent: Mozilla/5.0 (Windows NT 5.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1707.0 Safari/537.36\r\n" +
    ...
    private static String https(String https, String method, Pair<String, String>[] headers, String body){
        try {
