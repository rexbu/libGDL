...
public class GPU {
	static {
        ...
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "createTexture", "()I");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "destroyTexture", "(I)V");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "eglContext", "(Z)J");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setRenderSurface", "(Landroid/view/Surface;)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "makeCurrent", "(J)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "destroyEGL", "(J)V");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "processTexture", "(II)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "processBytes", "([BIII)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "getBytes", "([B)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "getTexture", "()I");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setOutputSize", "(II)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setOutputFormat", "(I)V");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setInputSize", "(II)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setInputRotation", "(I)V");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setPreviewMirror", "(Z)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setOutputMirror", "(Z)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setOutputRotation", "(I)V");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setSmoothStrength", "(F)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setBrightenLevel", "(F)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setToningLevel", "(F)V");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setExtraFilter", "(Ljava/lang/String;)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "closeExtraFilter", "()V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setExtraParameter", "(F)V");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setOutputView", "()V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "removeOutputView", "()V");

        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setPreviewBlend", "(Ljava/lang/String;FFFFZ)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPU", "setVideoBlend", "(Ljava/lang/String;FFFFZ)V");
	}
