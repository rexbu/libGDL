...
public class VSFacer {
    static {
        ...
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "loadFacerBuffer", "(Ljava/lang/String;[B)Z");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "loadFacerPath", "(Ljava/lang/String;Ljava/lang/String;)Z");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "destroyFacer", "()V");

        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "startFacerTracking", "()V");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "stopFacerTracking", "()V");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "isFacerTracking", "()Z");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "getFacerMarks", "(I)[F");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "getFacer3DAngle", "(I)[F");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "trackFacer", "([BIII)I");

        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "startShaper", "()V");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "stopShaper", "()V");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "setShapping", "(IF)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "emotion", "(II)Z");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "getFaceCount", "()I");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSFacer", "getFaceRect", "(I)[F");
    }
