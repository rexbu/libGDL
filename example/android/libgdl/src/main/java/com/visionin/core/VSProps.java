...
public class VSProps {
    static {
        ...
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSProps", "startProps", "(Ljava/lang/String;Z)Z");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSProps", "stopProps", "()V");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSProps", "startProps2", "(Ljava/lang/String;Z)Z");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSProps", "stopProps2", "()V");

        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSProps", "setTextureProps", "(Ljava/lang/String;)Z");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSProps", "renderTextureProps", "(IIZ)Z");
        NativeLoad.registerJNIMethod(so, "com/visionin/core/VSProps", "destroyProps", "()V");
    }
