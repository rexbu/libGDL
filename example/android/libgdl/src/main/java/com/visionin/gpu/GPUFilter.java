...
public class GPUFilter {
    ...
    static{
        ...
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPUFilter", "FCreateFilter", "(Ljava/lang/String;Ljava/lang/String;)J");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPUFilter", "FDestroyFilter", "(J)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPUFilter", "FSetInputTexture", "(JIII)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPUFilter", "FSetOutputRotation", "(JI)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPUFilter", "FSetOutputSize", "(JII)V");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPUFilter", "FGetOutputTexture", "(J)I");
        NativeLoad.registerJNIMethod(so, "com/visionin/gpu/GPUFilter", "FNewFrame", "(J)V");
    }
